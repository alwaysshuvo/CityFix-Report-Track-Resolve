...
const AllIssues = () => {
  ...
  const handleUpvote = (issueId) => {
    ...
    setIssues((prev) =>
      prev.map((it) =>
        it.id === issueId ? { ...it, upvotes: it.upvotes + 1 } : it
      )
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <h1
        className={`
          text-3xl font-bold mb-6 transition
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-3 mb-6">
        ...
        <select
          ...
          className={`
            ...
            ${dark ? "bg-[#111] border-purple-400/30 text-white" : "bg-white border-gray-300 text-black"}
          `}
        >
      ...
      <div className="flex items-center justify-center gap-3 mt-8">
        <button
          ...
          disabled={page === 1}
          className={`
            px-3 py-1 rounded transition border disabled:opacity-40
